...
import { ConnexionProfileType} from '@/api/viewer/viewer.types'
// types


// ==============================|| SOCIAL PROFILE - FOLLOWER CARD ||============================== //

const DiscountCard = ({ token,flag,profileEmail,profileId  }: ConnexionProfileType) => {
