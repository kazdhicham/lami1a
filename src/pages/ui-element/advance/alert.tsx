          ...
          <Grid item xs={12}>
            <SubCard title="Filled Alert">
              <Grid container direction="column" spacing={2}>
                ...
                <Grid item xs={12}>
                  <Alert variant="filled" severity="warning" sx={{ color: theme.palette.grey[800], bgcolor: theme.palette.warning.dark }}>
                    This is a warning alert — check it out!
                  </Alert>
                </Grid>
                <Grid item xs={12}>
...
UIAlert.getLayout = function getLayout(page: ReactElement) {
