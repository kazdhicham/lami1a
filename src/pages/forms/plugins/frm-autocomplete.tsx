            ...
            <Grid container spacing={gridSpacing}>
              ...
              <Grid item xs={12}>
                <SubCard title="Creatable">
                  <Autocomplete
                    value={value2}
                    onChange={(event: React.SyntheticEvent<Element, Event>, newValue: string | FilmFilter | null | undefined) => {
...
FrmAutocomplete.getLayout = function getLayout(page: ReactElement) {
